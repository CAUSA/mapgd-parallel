...
try
{	
	AnnotateMaps FAobj=new AnnotateMaps();
...
{
	System.out.println("\nThis program is to AnnotateMaps\n"); 
	System.out.println("\nUsage: Java -cp ./ AnnotateMaps <workdir> <FilteredMapFile> <AnnotatedMapFile> <HeadFile>\n"); 
